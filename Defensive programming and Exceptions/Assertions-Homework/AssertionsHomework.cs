...
class AssertionsHomework
{
        ...
        where T : IComparable<T>
    {
        ...
        Debug.Assert(startIndex > arr.Length, "Start index must be within array range");
        Debug.Assert(endIndex > arr.Length, "End index must be within array range");
        Debug.Assert(endIndex < 0, "End index must be positive");
        Debug.Assert(endIndex < startIndex, "End index must be greater than then start index");
